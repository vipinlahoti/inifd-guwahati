...
VulcanEmail.addTemplates({
  ...
  // newInstance:              Assets.getText('lib/server/emails/templates/instances/newInstance.handlebars'),
  // newPendingInstance:       Assets.getText('lib/server/emails/templates/instances/newPendingInstance.handlebars'),
  // instanceApproved:         Assets.getText('lib/server/emails/templates/instances/instanceApproved.handlebars'),
});
