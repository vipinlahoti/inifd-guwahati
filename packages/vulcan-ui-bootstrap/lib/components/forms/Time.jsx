...
class Time extends PureComponent {
  ...
  render() {
    ...
    const { inputProperties, layout } = this.props;
    ...
    return (
      <Components.FormItem path={inputProperties.path} layout={layout} label={inputProperties.label} {...this.props.itemProperties}>
        <DateTimePicker
          value={date}
          viewMode="time"
          dateFormat={false}
