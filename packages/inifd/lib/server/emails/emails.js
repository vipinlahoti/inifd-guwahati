...
//   query InstancesSingleQuery($documentId: String){
//     InstancesSingle(documentId: $documentId){
//       label
//       pageUrl
//       user {
//         pageUrl
...
// const dummyInstance = {label: '[label]', user: {displayName: '[user]'}};

// VulcanEmail.addEmails({
//   newInstance: {
//     template: 'newInstance',
//     path: '/email/new-instance/:_id?',
//     subject(data) {
//       const instance = _.isEmpty(data) ? dummyInstance : data.InstancesSingle;
//       return instance.user.displayName + ' has created a new instance: ' + instance.label;
//     },
//     query: instancesQuery
//   },
  
//   newPendingInstance: {
//     template: 'newPendingInstance',
//     path: '/email/new-pending-instance/:_id?',
//     subject(data) {
//       const instance = _.isEmpty(data) ? dummyInstance : data.InstancesSingle;
//       return instance.user.displayName + ' has a new instance pending approval: ' + instance.label;
//     },
//     query: instancesQuery
//   },
  
//   instanceApproved: {
//     template: 'instanceApproved',
//     path: '/email/instance-approved/:_id?',
//     subject(data) {
//       const instance = _.isEmpty(data) ? dummyInstance : data.InstancesSingle;
//       return 'Your instance “' + instance.label + '” has been approved';
//     },
//     query: instancesQuery
//   }
